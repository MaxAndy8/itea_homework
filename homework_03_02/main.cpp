...
{
    int       quantityKM = inputInt("Enter the quantity of kilometers: ", 0, std::numeric_limits<int>::max());
    long long quantityM  = 1000LL * quantityKM;

    std::cout << quantityKM << "km. = " << quantityM << "m." << std::endl;
    return 0;
}
